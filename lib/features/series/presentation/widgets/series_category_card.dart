// Kylos IPTV Player - Series Category Card
...
/// Card widget for displaying a Series category.
class SeriesCategoryCard extends StatefulWidget {
  const SeriesCategoryCard({
    super.key,
  ...
  @override
  State<SeriesCategoryCard> createState() => _SeriesCategoryCardState();
}

class _SeriesCategoryCardState extends State<SeriesCategoryCard> {
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  _formatCount(widget.category.seriesCount),
                  style: const TextStyle(
